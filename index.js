...
;(function () {
  ...
  Runner.prototype = {
    ...
    init: function () {
      ...
      params.get("reverse") === "true" ? (reverseRunner = true) : (reverseRunner = false)
      const wrapper = document.querySelector(".interstitial-wrapper")
      wrapper.style.justifyContent = reverseRunner ? "flex-end" : "flex-start"
      const container = document.querySelector(".runner-container")
      console.log(container)
      reverseRunner && container.classList.add("runner-container-flip")
    },
  ...
  DistanceMeter.prototype = {
    ...
    draw: function (digitPos, value, opt_highScore) {
      ...
      reverseRunner && this.canvasCtx.scale(-1, 1)
      this.canvasCtx.drawImage(
        this.image,
        sourceX,
        sourceY,
